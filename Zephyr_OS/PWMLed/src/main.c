...
#define PWM_LED0_NODE	DT_ALIAS(pwm1fabian)
...
void main(void) {
	...
	printk("PWM %s, %d, %d device\n", PWM_LABEL, PWM_CHANNEL, PWM_FLAGS);
	...
	ret = pwm_pin_set_usec(pwm, PWM_CHANNEL, max_period, max_period / 2U,
			PWM_FLAGS);
